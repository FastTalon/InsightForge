# -*- coding: utf-8 -*-
"""InsightForge_Colab___Working_.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Wdy6kNPIE-z22IiZJ2TVZaS6DSYyT1kW
...
# Load necessary keys from Colab Secrets
try:
    os.environ['OPENAI_API_KEY'] = userdata.get('OPENAI_API_KEY')
except Exception: # Changed to specific Exception
    print("OPENAI_API_KEY not found in Colab Secrets. Set this key.")

try:
    os.environ['GROQ_API_KEY'] = userdata.get('GROQ_API_KEY')
except Exception: # Changed to specific Exception
    print("GROQ_API_KEY not found in Colab Secrets. Set this key if you prefer Groq.")

try:
    # ngrok is required to expose the Streamlit app to the web
    NGROK_AUTH_TOKEN = userdata.get('NGROK_AUTH_TOKEN')
    if NGROK_AUTH_TOKEN:
        !ngrok authtoken $NGROK_AUTH_TOKEN
    else:
        print("NGROK_AUTH_TOKEN not found in Colab Secrets. You must set this for Streamlit to run in Colab.")
except Exception as e: # Changed to specific Exception and captured error
    print(f"NGROK_AUTH_TOKEN not found or auth failed. You must set this for Streamlit to run in Colab. Error: {e}")

# Placeholder for other keys
# Fix: userdata.get() takes 1 positional argument. Handle default value separately.
os.environ['ANTHROPIC_API_KEY'] = userdata.get('ANTHROPIC_API_KEY') or 'placeholder'
os.environ['BRAVE_API_KEY'] = userdata.get('BRAVE_API_KEY') or 'placeholder'
os.environ['HF_TOKEN'] = userdata.get('HF_TOKEN') or 'placeholder'
os.environ['NEWSAPI_KEY'] = userdata.get('NEWSAPI_KEY') or 'placeholder'
os.environ['SERPER_API_KEY'] = userdata.get('SERPER_API_KEY') or 'placeholder'

print("Environment variables loaded. Ready to proceed.")

import pandas as pd
import numpy as np

# Commented out IPython magic to ensure Python compatibility.
# %%writefile InsightForge.py
...
#     st.error("FATAL: Neither OPENAI_API_KEY nor GROQ_API_KEY are set. Please check Colab Secrets.")
#     st.stop()
# 
...
!nohup streamlit run InsightForge.py &>/content/streamlit.log &
...
try:
    ...
    print(f"\n🚀 Your InsightForge App is running at: {ngrok_tunnel.public_url}")
except Exception as e:
    print(f"Failed to create ngrok tunnel. Error: {e}")
    print("Ensure NGROK_AUTH_TOKEN is correctly set in Colab Secrets and authenticated.")